...
class CurrentWeatherBigCard extends StatefulWidget {
  const CurrentWeatherBigCard({Key? key}) : super(key: key);

  @override
  _CurrentWeatherBigCard createState() => _CurrentWeatherBigCard();
}

class _CurrentWeatherBigCard extends State<CurrentWeatherBigCard> {
            ...
            children: [
              state.result?.current?.weather?[0].icon == ""
                  ...
                  : CachedNetworkImage(
                      ...
                      fit: BoxFit.cover,
                      height:
                          (state.loadStatus == LoadStatus.SUCCESS) ? 240 : 100,
